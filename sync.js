...
const CONFIG = {
    ...
    databaseName: "dashboard_fo",

    sheets: [

        {
            sheetName: "List Mitra",
            collectionName: "list_mitra"
        }

        // Tambah sheet lainnya di sini.
        //
        // {
        //     sheetName: "Loan",
        //     collectionName: "loan"
...
async function main() {
    ...
    try {
        ...
        console.log("");
        console.log("ALL SHEETS SYNC SUCCESS.");
        console.log("");
